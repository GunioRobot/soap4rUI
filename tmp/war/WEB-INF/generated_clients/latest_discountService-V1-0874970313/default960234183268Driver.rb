...
require 'default960234183268MappingRegistry.rb'
...
class DiscountServicePortType < ::SOAP::RPC::Driver
  ...
  Methods = [
    ...
    [ "applyDiscount",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"MySoap::Interface880641847::DiscountServiceFault"=>{:ns=>"http://services.gid.gap.com/discountService/v1", :name=>"DiscountServiceFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ]
  ]
