...
module MySoap; module Interface334562106
...
module GoogleSearchMappingRegistry
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface334562106::GoogleSearchResult,
    ...
    :schema_element => [
      ...
      ["resultElements", ["MySoap::Interface334562106::ResultElementArray", XSD::QName.new(nil, "resultElements")]],
      ...
      ["directoryCategories", ["MySoap::Interface334562106::DirectoryCategoryArray", XSD::QName.new(nil, "directoryCategories")]],
      ["searchTime", ["SOAP::SOAPDouble", XSD::QName.new(nil, "searchTime")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface334562106::ResultElement,
    ...
    :schema_element => [
      ...
      ["directoryCategory", ["MySoap::Interface334562106::DirectoryCategory", XSD::QName.new(nil, "directoryCategory")]],
      ["directoryTitle", ["SOAP::SOAPString", XSD::QName.new(nil, "directoryTitle")]]
    ]
  )

  EncodedRegistry.set(
    MySoap::Interface334562106::ResultElementArray,
    ::SOAP::SOAPArray,
  ...
  EncodedRegistry.set(
    MySoap::Interface334562106::DirectoryCategoryArray,
    ::SOAP::SOAPArray,
    ::SOAP::Mapping::EncodedRegistry::TypedArrayFactory,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface334562106::DirectoryCategory,
