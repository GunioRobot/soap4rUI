...
require 'default1242249916MappingRegistry.rb'
require 'soap/rpc/driver'

module MySoap::Interface444904713
...
class DiscountServicePortType < ::SOAP::RPC::Driver
  ...
  Methods = [
    ...
    [ "applyDiscount",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"MySoap::Interface444904713::DiscountServiceFault"=>{:use=>"literal", :ns=>"http://services.gid.gap.com/discountService/v1", :namespace=>nil, :name=>"DiscountServiceFault", :encodingstyle=>"document"}} }
    ]
  ]
