require 'GoogleSearch1242284265.rb'
...
module GoogleSearchMappingRegistry
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface386283172::GoogleSearchResult,
    ...
    :schema_element => [
      ...
      ["resultElements", ["MySoap::Interface386283172::ResultElementArray", XSD::QName.new(nil, "resultElements")]],
      ...
      ["directoryCategories", ["MySoap::Interface386283172::DirectoryCategoryArray", XSD::QName.new(nil, "directoryCategories")]],
      ["searchTime", ["SOAP::SOAPDouble", XSD::QName.new(nil, "searchTime")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface386283172::ResultElement,
    ...
    :schema_element => [
      ...
      ["directoryCategory", ["MySoap::Interface386283172::DirectoryCategory", XSD::QName.new(nil, "directoryCategory")]],
      ["directoryTitle", ["SOAP::SOAPString", XSD::QName.new(nil, "directoryTitle")]]
    ]
  )

  EncodedRegistry.set(
    MySoap::Interface386283172::ResultElementArray,
    ::SOAP::SOAPArray,
  ...
  EncodedRegistry.set(
    MySoap::Interface386283172::DirectoryCategoryArray,
    ::SOAP::SOAPArray,
    ::SOAP::Mapping::EncodedRegistry::TypedArrayFactory,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface386283172::DirectoryCategory,
