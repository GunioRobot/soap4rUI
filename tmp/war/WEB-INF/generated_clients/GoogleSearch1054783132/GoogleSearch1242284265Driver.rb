...
require 'GoogleSearch1242284265MappingRegistry.rb'
require 'soap/rpc/driver'

module MySoap::Interface386283172
  ...
  Methods = [
    ...
    [ XSD::QName.new(NsGoogleSearch, "doGoogleSearch"),
      ...
      [ ["in", "key", ["::SOAP::SOAPString"]],
        ...
        ["retval", "return", ["MySoap::Interface386283172::GoogleSearchResult", "urn:GoogleSearch", "GoogleSearchResult"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {} }
    ]
