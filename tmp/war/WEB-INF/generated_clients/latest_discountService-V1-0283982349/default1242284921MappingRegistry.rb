require 'default1242284921.rb'
require 'soap/mapping'

module MySoap; module Interface1129907743
...
module DefaultMappingRegistry
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1129907743::DiscountServiceRequestType,
    ...
    :schema_element => [
      ...
      ["orderRequest", ["MySoap::Interface1129907743::OrderType", XSD::QName.new(nil, "orderRequest")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1129907743::DiscountServiceResponseType,
    :schema_type => XSD::QName.new(NsV1, "DiscountServiceResponseType"),
    :schema_element => [
      ["orderResponse", ["MySoap::Interface1129907743::OrderType", XSD::QName.new(nil, "orderResponse")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1129907743::OrderType,
    :schema_type => XSD::QName.new(NsV1, "OrderType"),
    :schema_element => [
      ["orderID", ["SOAP::SOAPString", XSD::QName.new(nil, "OrderID")], [0, 1]],
      ["qualifyType", ["MySoap::Interface1129907743::QualifyTypeEnum", XSD::QName.new(nil, "QualifyType")], [0, 1]],
      ...
      ["orderLineItems", ["MySoap::Interface1129907743::OrderLineType[]", XSD::QName.new(nil, "OrderLineItems")], [0, nil]],
      ["promotions", ["MySoap::Interface1129907743::PromotionType[]", XSD::QName.new(nil, "Promotions")], [0, nil]],
      ["tenders", ["MySoap::Interface1129907743::TenderInfoType[]", XSD::QName.new(nil, "Tenders")], [0, nil]],
      ["maxDiscountsAllowed", ["SOAP::SOAPInt", XSD::QName.new(nil, "MaxDiscountsAllowed")], [0, 1]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1129907743::TenderInfoType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1129907743::PromotionType,
    ...
    :schema_element => [
      ...
      ["appliedStatus", ["MySoap::Interface1129907743::AppliedStatusEnum", XSD::QName.new(nil, "AppliedStatus")], [0, 1]],
      ["receiptMessages", ["MySoap::Interface1129907743::ReceiptMessageType[]", XSD::QName.new(nil, "ReceiptMessages")], [0, nil]],
      ["promoUsages", ["MySoap::Interface1129907743::PromoUsageType[]", XSD::QName.new(nil, "PromoUsages")], [0, nil]],
      ["qualifyingTenders", ["SOAP::SOAPString[]", XSD::QName.new(nil, "QualifyingTenders")], [0, nil]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1129907743::PromoUsageType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1129907743::ReceiptMessageType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1129907743::OrderLineType,
    :schema_type => XSD::QName.new(NsV1, "OrderLineType"),
    :schema_element => [
      ["sequenceNumber", ["SOAP::SOAPInt", XSD::QName.new(nil, "SequenceNumber")]],
      ["product", ["MySoap::Interface1129907743::ProductInfoType", XSD::QName.new(nil, "Product")]],
      ["price", ["MySoap::Interface1129907743::PriceInfoType", XSD::QName.new(nil, "Price")]],
      ["quantity", ["SOAP::SOAPInt", XSD::QName.new(nil, "Quantity")]],
      ["awards", ["MySoap::Interface1129907743::AwardType[]", XSD::QName.new(nil, "Awards")], [0, nil]],
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1129907743::AwardType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1129907743::ProductInfoType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1129907743::PriceInfoType,
    ...
    :schema_element => [
      ...
      ["priceType", ["MySoap::Interface1129907743::PriceTypeEnum", XSD::QName.new(nil, "PriceType")], [0, 1]],
      ["discountPrice", ["SOAP::SOAPDecimal", XSD::QName.new(nil, "DiscountPrice")], [0, 1]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1129907743::ServiceAliveRequestType,
    :schema_type => XSD::QName.new(NsV1_0, "ServiceAliveRequestType"),
    :schema_element => []
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1129907743::ServiceAliveResponseType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1129907743::ServiceUnavailableFaultMessageType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1129907743::QualifyTypeEnum,
    :schema_type => XSD::QName.new(NsV1, "QualifyTypeEnum")
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1129907743::AppliedStatusEnum,
    :schema_type => XSD::QName.new(NsV1, "AppliedStatusEnum")
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1129907743::PriceTypeEnum,
