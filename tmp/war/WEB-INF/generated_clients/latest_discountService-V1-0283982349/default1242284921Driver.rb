...
require 'default1242284921MappingRegistry.rb'
require 'soap/rpc/driver'

module MySoap::Interface1129907743
...
class DiscountServicePortType < ::SOAP::RPC::Driver
  ...
  Methods = [
    ...
    [ "applyDiscount",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"MySoap::Interface1129907743::DiscountServiceFault"=>{:use=>"literal", :ns=>"http://services.gid.gap.com/discountService/v1", :namespace=>nil, :encodingstyle=>"document", :name=>"DiscountServiceFault"}} }
    ]
  ]
