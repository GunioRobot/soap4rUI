...
require 'default1242249906MappingRegistry.rb'
require 'soap/rpc/driver'

module MySoap::Interface217180176
...
class DiscountServicePortType < ::SOAP::RPC::Driver
  ...
  Methods = [
    ...
    [ "applyDiscount",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"MySoap::Interface217180176::DiscountServiceFault"=>{:use=>"literal", :ns=>"http://services.gid.gap.com/discountService/v1", :namespace=>nil, :name=>"DiscountServiceFault", :encodingstyle=>"document"}} }
    ]
  ]
