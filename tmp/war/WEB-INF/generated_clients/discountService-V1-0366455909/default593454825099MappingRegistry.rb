require 'default593454825099.rb'
require 'soap/mapping'

module MySoap; module Interface1031589521
...
module DefaultMappingRegistry
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1031589521::DiscountServiceRequestType,
    ...
    :schema_element => [
      ...
      ["orderRequest", ["MySoap::Interface1031589521::OrderType", XSD::QName.new(nil, "orderRequest")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1031589521::DiscountServiceResponseType,
    :schema_type => XSD::QName.new(NsV1, "DiscountServiceResponseType"),
    :schema_element => [
      ["orderResponse", ["MySoap::Interface1031589521::OrderType", XSD::QName.new(nil, "orderResponse")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1031589521::OrderType,
    :schema_type => XSD::QName.new(NsV1, "OrderType"),
    :schema_element => [
      ["orderID", ["SOAP::SOAPString", XSD::QName.new(nil, "OrderID")], [0, 1]],
      ["qualifyType", ["MySoap::Interface1031589521::QualifyTypeEnum", XSD::QName.new(nil, "QualifyType")], [0, 1]],
      ...
      ["orderLineItems", ["MySoap::Interface1031589521::OrderLineType[]", XSD::QName.new(nil, "OrderLineItems")], [0, nil]],
      ["promotions", ["MySoap::Interface1031589521::PromotionType[]", XSD::QName.new(nil, "Promotions")], [0, nil]],
      ["tenderTypes", ["MySoap::Interface1031589521::TenderInfoType[]", XSD::QName.new(nil, "TenderTypes")], [0, nil]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1031589521::TenderInfoType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1031589521::PromotionType,
    ...
    :schema_element => [
      ...
      ["appliedStatus", ["MySoap::Interface1031589521::AppliedStatusEnum", XSD::QName.new(nil, "AppliedStatus")], [0, 1]],
      ["receiptMessages", ["MySoap::Interface1031589521::ReceiptMessageType[]", XSD::QName.new(nil, "ReceiptMessages")], [0, nil]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1031589521::ReceiptMessageType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1031589521::OrderLineType,
    :schema_type => XSD::QName.new(NsV1, "OrderLineType"),
    :schema_element => [
      ["sequenceNumber", ["SOAP::SOAPInt", XSD::QName.new(nil, "SequenceNumber")]],
      ["product", ["MySoap::Interface1031589521::ProductInfoType", XSD::QName.new(nil, "Product")]],
      ["quantity", ["SOAP::SOAPInt", XSD::QName.new(nil, "Quantity")]],
      ["discountPrice", ["SOAP::SOAPDecimal", XSD::QName.new(nil, "DiscountPrice")], [0, 1]],
      ["awards", ["MySoap::Interface1031589521::AwardType[]", XSD::QName.new(nil, "Awards")], [0, nil]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1031589521::AwardType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1031589521::ProductInfoType,
    ...
    :schema_element => [
      ...
      ["priceType", ["MySoap::Interface1031589521::PriceTypeEnum", XSD::QName.new(nil, "PriceType")], [0, 1]],
      ["merchandiseType", ["SOAP::SOAPInt", XSD::QName.new(nil, "MerchandiseType")], [0, 1]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1031589521::ServiceAliveRequestType,
    :schema_type => XSD::QName.new(NsV1_0, "ServiceAliveRequestType"),
    :schema_element => []
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1031589521::ServiceAliveResponseType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1031589521::ServiceUnavailableFaultMessageType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1031589521::QualifyTypeEnum,
    :schema_type => XSD::QName.new(NsV1, "QualifyTypeEnum")
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1031589521::AppliedStatusEnum,
    :schema_type => XSD::QName.new(NsV1, "AppliedStatusEnum")
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1031589521::PriceTypeEnum,
