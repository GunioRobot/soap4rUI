...
require 'default593454825099MappingRegistry.rb'
require 'soap/rpc/driver'

module MySoap::Interface1031589521
...
class DiscountServicePortType < ::SOAP::RPC::Driver
  ...
  Methods = [
    ...
    [ "applyDiscount",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"MySoap::Interface1031589521::DiscountServiceFault"=>{:ns=>"http://services.gid.gap.com/discountService/v1", :name=>"DiscountServiceFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ]
  ]
