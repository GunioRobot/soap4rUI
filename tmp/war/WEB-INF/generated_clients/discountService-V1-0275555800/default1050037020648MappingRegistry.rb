require 'default1050037020648.rb'
require 'soap/mapping'

module MySoap; module Interface683834416
...
module DefaultMappingRegistry
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface683834416::DiscountServiceRequestType,
    ...
    :schema_element => [
      ...
      ["orderRequest", ["MySoap::Interface683834416::OrderType", XSD::QName.new(nil, "orderRequest")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface683834416::DiscountServiceResponseType,
    :schema_type => XSD::QName.new(NsV1, "DiscountServiceResponseType"),
    :schema_element => [
      ["orderResponse", ["MySoap::Interface683834416::OrderType", XSD::QName.new(nil, "orderResponse")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface683834416::OrderType,
    :schema_type => XSD::QName.new(NsV1, "OrderType"),
    :schema_element => [
      ["orderID", ["SOAP::SOAPString", XSD::QName.new(nil, "OrderID")], [0, 1]],
      ["qualifyType", ["MySoap::Interface683834416::QualifyTypeEnum", XSD::QName.new(nil, "QualifyType")], [0, 1]],
      ...
      ["orderLineItems", ["MySoap::Interface683834416::OrderLineType[]", XSD::QName.new(nil, "OrderLineItems")], [0, nil]],
      ["promotions", ["MySoap::Interface683834416::PromotionType[]", XSD::QName.new(nil, "Promotions")], [0, nil]],
      ["tenderTypes", ["MySoap::Interface683834416::TenderInfoType[]", XSD::QName.new(nil, "TenderTypes")], [0, nil]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface683834416::TenderInfoType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface683834416::PromotionType,
    ...
    :schema_element => [
      ...
      ["appliedStatus", ["MySoap::Interface683834416::AppliedStatusEnum", XSD::QName.new(nil, "AppliedStatus")], [0, 1]],
      ["receiptMessages", ["MySoap::Interface683834416::ReceiptMessageType[]", XSD::QName.new(nil, "ReceiptMessages")], [0, nil]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface683834416::ReceiptMessageType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface683834416::OrderLineType,
    :schema_type => XSD::QName.new(NsV1, "OrderLineType"),
    :schema_element => [
      ["sequenceNumber", ["SOAP::SOAPInt", XSD::QName.new(nil, "SequenceNumber")]],
      ["product", ["MySoap::Interface683834416::ProductInfoType", XSD::QName.new(nil, "Product")]],
      ["quantity", ["SOAP::SOAPInt", XSD::QName.new(nil, "Quantity")]],
      ["discountPrice", ["SOAP::SOAPDecimal", XSD::QName.new(nil, "DiscountPrice")], [0, 1]],
      ["awards", ["MySoap::Interface683834416::AwardType[]", XSD::QName.new(nil, "Awards")], [0, nil]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface683834416::AwardType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface683834416::ProductInfoType,
    ...
    :schema_element => [
      ...
      ["priceType", ["MySoap::Interface683834416::PriceTypeEnum", XSD::QName.new(nil, "PriceType")], [0, 1]],
      ["merchandiseType", ["SOAP::SOAPInt", XSD::QName.new(nil, "MerchandiseType")], [0, 1]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface683834416::ServiceAliveRequestType,
    :schema_type => XSD::QName.new(NsV1_0, "ServiceAliveRequestType"),
    :schema_element => []
  )

  EncodedRegistry.register(
    :class => MySoap::Interface683834416::ServiceAliveResponseType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface683834416::ServiceUnavailableFaultMessageType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface683834416::QualifyTypeEnum,
    :schema_type => XSD::QName.new(NsV1, "QualifyTypeEnum")
  )

  EncodedRegistry.register(
    :class => MySoap::Interface683834416::AppliedStatusEnum,
    :schema_type => XSD::QName.new(NsV1, "AppliedStatusEnum")
  )

  EncodedRegistry.register(
    :class => MySoap::Interface683834416::PriceTypeEnum,
