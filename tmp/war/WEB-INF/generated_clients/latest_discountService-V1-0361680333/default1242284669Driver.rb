...
require 'default1242284669MappingRegistry.rb'
require 'soap/rpc/driver'

module MySoap::Interface65411588
...
class DiscountServicePortType < ::SOAP::RPC::Driver
  ...
  Methods = [
    ...
    [ "applyDiscount",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"MySoap::Interface65411588::DiscountServiceFault"=>{:use=>"literal", :ns=>"http://services.gid.gap.com/discountService/v1", :namespace=>nil, :name=>"DiscountServiceFault", :encodingstyle=>"document"}} }
    ]
  ]
