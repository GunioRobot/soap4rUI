...
module DefaultMappingRegistry
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface880641847::VaultID,
  ...
  LiteralRegistry.register(
    :class => MySoap::Interface880641847::GetVaultIDRequest,
  ...
  LiteralRegistry.register(
    :class => MySoap::Interface880641847::GetVaultIDResponse,
    :schema_name => XSD::QName.new(NsV1, "GetVaultIDResponse"),
    :schema_element => [
      ["getVaultIDReturn", ["MySoap::Interface880641847::VaultID", XSD::QName.new(nil, "getVaultIDReturn")]]
    ]
  )

  LiteralRegistry.register(
    :class => MySoap::Interface880641847::StoreRequest,
  ...
  LiteralRegistry.register(
    :class => MySoap::Interface880641847::StoreResponse,
    :schema_name => XSD::QName.new(NsV1, "StoreResponse"),
    :schema_element => [
      ["storeReturn", ["MySoap::Interface880641847::VaultID", XSD::QName.new(nil, "storeReturn")]]
    ]
  )

  LiteralRegistry.register(
    :class => MySoap::Interface880641847::RetrieveRequest,
    :schema_name => XSD::QName.new(NsV1, "RetrieveRequest"),
    :schema_element => [
      ["id", ["MySoap::Interface880641847::VaultID", XSD::QName.new(nil, "id")]]
    ]
  )

  LiteralRegistry.register(
    :class => MySoap::Interface880641847::RetrieveResponse,
