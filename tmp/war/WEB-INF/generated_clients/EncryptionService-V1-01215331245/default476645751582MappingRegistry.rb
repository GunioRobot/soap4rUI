...
module MySoap; module Interface150886566
...
module DefaultMappingRegistry
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface150886566::VaultID,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface150886566::ServiceAliveRequestType,
    :schema_type => XSD::QName.new(NsV1_0, "ServiceAliveRequestType"),
    :schema_element => []
  )

  EncodedRegistry.register(
    :class => MySoap::Interface150886566::ServiceAliveResponseType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface150886566::ServiceUnavailableFaultMessageType,
  ...
  LiteralRegistry.register(
    :class => MySoap::Interface150886566::GetVaultIDRequest,
  ...
  LiteralRegistry.register(
    :class => MySoap::Interface150886566::GetVaultIDResponse,
    :schema_name => XSD::QName.new(NsV1, "GetVaultIDResponse"),
    :schema_element => [
      ["getVaultIDReturn", ["MySoap::Interface150886566::VaultID", XSD::QName.new(nil, "getVaultIDReturn")]]
    ]
  )

  LiteralRegistry.register(
    :class => MySoap::Interface150886566::StoreRequest,
  ...
  LiteralRegistry.register(
    :class => MySoap::Interface150886566::StoreResponse,
    :schema_name => XSD::QName.new(NsV1, "StoreResponse"),
    :schema_element => [
      ["storeReturn", ["MySoap::Interface150886566::VaultID", XSD::QName.new(nil, "storeReturn")]]
    ]
  )

  LiteralRegistry.register(
    :class => MySoap::Interface150886566::RetrieveRequest,
    :schema_name => XSD::QName.new(NsV1, "RetrieveRequest"),
    :schema_element => [
      ["id", ["MySoap::Interface150886566::VaultID", XSD::QName.new(nil, "id")]]
    ]
  )

  LiteralRegistry.register(
    :class => MySoap::Interface150886566::RetrieveResponse,
