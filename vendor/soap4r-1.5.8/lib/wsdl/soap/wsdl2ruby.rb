...
class WSDL2Ruby
  ...
  def run
    # puts "opt #{@opt}"
    # puts "classdef #{@opt['classdef']}"
    # puts "mapping_registry #{@opt['mapping_registry']}"
    # puts "driver #{@opt['driver']}"
    # puts "@modulepath = #{@modulepath}"
...
private
  ...
  def create_driver(porttypename, drivername_postfix)
    @logger.info { "Creating driver. with port type name = #{porttypename}, #{drivername_postfix}" }
  ...
  def create_name(name)
    # puts "create_name = #{name}, #{@wsdl.targetnamespace}"
    # puts "opt #{@opt}"
    # puts "classdef #{@opt['classdef']}"
    # puts "mapping_registry #{@opt['mapping_registry']}"
    # puts "driver #{@opt['driver']}"
