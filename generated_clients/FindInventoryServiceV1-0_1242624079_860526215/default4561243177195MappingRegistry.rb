...
module MySoap; module Interface67314003
...
module DefaultMappingRegistry
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface67314003::FindInventoryRequestDTO,
    :schema_type => XSD::QName.new(NsDtoV1FindInventoryServicesGidGapCom, "FindInventoryRequestDTO"),
    :schema_element => [
      ["promiseObj", ["MySoap::Interface67314003::PromiseDTO", XSD::QName.new(nil, "promiseObj")]],
      ["envObj", ["MySoap::Interface67314003::EnvironmentDTO", XSD::QName.new(nil, "envObj")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface67314003::PromiseDTO,
    ...
    :schema_element => [
      ...
      ["promiseLines", ["MySoap::Interface67314003::ArrayOf_tns2_PromiseLineDTO", XSD::QName.new(nil, "promiseLines")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface67314003::PromiseLineDTO,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface67314003::FindInventoryResponseDTO,
    :schema_type => XSD::QName.new(NsDtoV1FindInventoryServicesGidGapCom, "FindInventoryResponseDTO"),
    :schema_element => [
      ["itemList", ["MySoap::Interface67314003::ItemListDTO", XSD::QName.new(nil, "itemList")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface67314003::ItemListDTO,
    :schema_type => XSD::QName.new(NsDtoV1FindInventoryServicesGidGapCom, "ItemListDTO"),
    :schema_element => [
      ["availableItems", ["MySoap::Interface67314003::ArrayOf_tns2_AvailableItemDTO", XSD::QName.new(nil, "availableItems")]],
      ["unavailableItems", ["MySoap::Interface67314003::ArrayOf_tns2_UnavailableItemDTO", XSD::QName.new(nil, "unavailableItems")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface67314003::AvailableItemDTO,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface67314003::UnavailableItemDTO,
  ...
  EncodedRegistry.set(
    MySoap::Interface67314003::ArrayOf_tns2_PromiseLineDTO,
    ::SOAP::SOAPArray,
  ...
  EncodedRegistry.set(
    MySoap::Interface67314003::ArrayOf_tns2_AvailableItemDTO,
    ::SOAP::SOAPArray,
    ::SOAP::Mapping::EncodedRegistry::TypedArrayFactory,
  ...
  EncodedRegistry.set(
    MySoap::Interface67314003::ArrayOf_tns2_UnavailableItemDTO,
    ::SOAP::SOAPArray,
    ::SOAP::Mapping::EncodedRegistry::TypedArrayFactory,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface67314003::EnvironmentDTO,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface67314003::FindInventoryServiceException,
