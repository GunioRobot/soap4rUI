...
module MySoap; module Interface1242620054_977234956
...
module DefaultMappingRegistry
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1242620054_977234956::CreditCardValidationRequest,
  ...
  EncodedRegistry.set(
    MySoap::Interface1242620054_977234956::ArrayOf_xsd_string,
    ::SOAP::SOAPArray,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1242620054_977234956::PromotionUsage,
  ...
  EncodedRegistry.set(
    MySoap::Interface1242620054_977234956::ArrayOf_PromotionUsage,
    ::SOAP::SOAPArray,
    ::SOAP::Mapping::EncodedRegistry::TypedArrayFactory,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1242620054_977234956::CreditCardValidationInfo,
    ...
    :schema_element => [
      ...
      ["promotionUsageHistory", ["MySoap::Interface1242620054_977234956::ArrayOf_PromotionUsage", XSD::QName.new(nil, "promotionUsageHistory")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1242620054_977234956::CreditCardValidationResponse,
    :schema_type => XSD::QName.new(NsProviderV1PromotionServicesGidGapCom, "CreditCardValidationResponse"),
    :schema_element => [
      ["creditCardValidationInfo", ["MySoap::Interface1242620054_977234956::CreditCardValidationInfo", XSD::QName.new(nil, "creditCardValidationInfo")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1242620054_977234956::PromotionServiceException,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1242620054_977234956::PromoValidationException,
