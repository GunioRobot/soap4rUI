...
class PromotionUsagePortType < ::SOAP::RPC::Driver
  ...
  Methods = [
    ...
    [ "getPromotionUsages",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"MySoap::Interface893988089::PromotionUsageFault"=>{:namespace=>nil, :use=>"literal", :ns=>"http://services.gid.gap.com/promotionusage/v1", :name=>"PromotionUsageFault", :encodingstyle=>"document"}} }
    ]
  ]
