...
module DefaultMappingRegistry
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface893988089::PromotionUsageType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface893988089::PromotionUsagesType,
    :schema_type => XSD::QName.new(NsV1, "PromotionUsagesType"),
    :schema_element => [
      ["promotionUsage", ["MySoap::Interface893988089::PromotionUsageType[]", XSD::QName.new(nil, "PromotionUsage")], [0, nil]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface893988089::PromotionUsageRequestType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface893988089::PromotionUsageResponseType,
    :schema_type => XSD::QName.new(NsV1, "PromotionUsageResponseType"),
    :schema_element => [
      ["promotionUsages", ["MySoap::Interface893988089::PromotionUsagesType", XSD::QName.new(nil, "PromotionUsages")]],
