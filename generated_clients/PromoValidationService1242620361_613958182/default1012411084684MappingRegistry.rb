...
module MySoap; module Interface211857796
...
module DefaultMappingRegistry
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface211857796::CreditCardValidationRequest,
  ...
  EncodedRegistry.set(
    MySoap::Interface211857796::ArrayOf_xsd_string,
    ::SOAP::SOAPArray,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface211857796::PromotionUsage,
  ...
  EncodedRegistry.set(
    MySoap::Interface211857796::ArrayOf_PromotionUsage,
    ::SOAP::SOAPArray,
    ::SOAP::Mapping::EncodedRegistry::TypedArrayFactory,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface211857796::CreditCardValidationInfo,
    ...
    :schema_element => [
      ...
      ["promotionUsageHistory", ["MySoap::Interface211857796::ArrayOf_PromotionUsage", XSD::QName.new(nil, "promotionUsageHistory")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface211857796::CreditCardValidationResponse,
    :schema_type => XSD::QName.new(NsProviderV1PromotionServicesGidGapCom, "CreditCardValidationResponse"),
    :schema_element => [
      ["creditCardValidationInfo", ["MySoap::Interface211857796::CreditCardValidationInfo", XSD::QName.new(nil, "creditCardValidationInfo")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface211857796::PromotionServiceException,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface211857796::PromoValidationException,
