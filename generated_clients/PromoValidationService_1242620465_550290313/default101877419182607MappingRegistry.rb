...
module DefaultMappingRegistry
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface491263::CreditCardValidationRequest,
  ...
  EncodedRegistry.set(
    MySoap::Interface491263::ArrayOf_xsd_string,
    ::SOAP::SOAPArray,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface491263::PromotionUsage,
  ...
  EncodedRegistry.set(
    MySoap::Interface491263::ArrayOf_PromotionUsage,
    ::SOAP::SOAPArray,
    ::SOAP::Mapping::EncodedRegistry::TypedArrayFactory,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface491263::CreditCardValidationInfo,
    ...
    :schema_element => [
      ...
      ["promotionUsageHistory", ["MySoap::Interface491263::ArrayOf_PromotionUsage", XSD::QName.new(nil, "promotionUsageHistory")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface491263::CreditCardValidationResponse,
    :schema_type => XSD::QName.new(NsProviderV1PromotionServicesGidGapCom, "CreditCardValidationResponse"),
    :schema_element => [
      ["creditCardValidationInfo", ["MySoap::Interface491263::CreditCardValidationInfo", XSD::QName.new(nil, "creditCardValidationInfo")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface491263::PromotionServiceException,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface491263::PromoValidationException,
