...
class FindInventoryServiceBean < ::SOAP::RPC::Driver
  ...
  Methods = [
    [ XSD::QName.new(NsProviderV1FindInventoryServicesGidGapCom, "findInventory"),
      "",
      "findInventory",
      [ ["in", "findInvReqObj", ["MySoap::Interface491263::FindInventoryRequestDTO", "http://dto.v1.findInventory.services.gid.gap.com", "FindInventoryRequestDTO"]],
        ["retval", "findInventoryReturn", ["MySoap::Interface491263::FindInventoryResponseDTO", "http://dto.v1.findInventory.services.gid.gap.com", "FindInventoryResponseDTO"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"MySoap::Interface491263::FindInventoryServiceException_"=>{:namespace=>nil, :use=>"encoded", :ns=>"http://provider.v1.findInventory.services.gid.gap.com", :name=>"FindInventoryServiceException", :encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/"}} }
    ],
