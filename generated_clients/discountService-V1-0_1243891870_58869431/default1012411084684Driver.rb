...
module MySoap::Interface119325561
...
class DiscountServicePortType < ::SOAP::RPC::Driver
  ...
  Methods = [
    ...
    [ "applyDiscount",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"MySoap::Interface119325561::DiscountServiceFault"=>{:namespace=>nil, :use=>"literal", :ns=>"http://services.gid.gap.com/discountService/v1", :name=>"DiscountServiceFault", :encodingstyle=>"document"}} }
    ]
  ]
