...
module MySoap::Interface648533956
...
class DiscountServicePortType < ::SOAP::RPC::Driver
  ...
  Methods = [
    ...
    [ "applyDiscount",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"MySoap::Interface648533956::DiscountServiceFault"=>{:use=>"literal", :namespace=>nil, :ns=>"http://services.gid.gap.com/discountService/v1", :encodingstyle=>"document", :name=>"DiscountServiceFault"}} }
    ]
  ]
