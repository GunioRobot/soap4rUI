...
module IcmFindInventoryServiceV10MappingRegistry
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface491263::PromiseLinesInputType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface491263::FindInventoryResponseType,
    :schema_type => XSD::QName.new(NsV1, "FindInventoryResponseType"),
    :schema_element => [
      ["promiseLinesOutput", ["MySoap::Interface491263::PromiseLinesOutputType[]", XSD::QName.new(nil, "PromiseLinesOutput")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface491263::PromiseLinesOutputType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface491263::FindGlobalInventoryRequestType,
  ...
  LiteralRegistry.register(
    :class => MySoap::Interface491263::FindInventoryRequest,
    :schema_name => XSD::QName.new(NsV1, "FindInventoryRequest"),
    :schema_element => [
      ["promiseLinesInput", ["MySoap::Interface491263::PromiseLinesInputType[]", XSD::QName.new(nil, "PromiseLinesInput")]]
    ]
  )
  ...
  LiteralRegistry.register(
    :class => MySoap::Interface491263::FindInventoryByDCRequest,
