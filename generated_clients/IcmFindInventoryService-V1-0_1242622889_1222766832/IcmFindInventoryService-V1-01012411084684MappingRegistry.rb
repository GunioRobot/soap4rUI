...
module MySoap; module Interface989386629
...
module IcmFindInventoryServiceV10MappingRegistry
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface989386629::PromiseLinesInputType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface989386629::FindInventoryResponseType,
    :schema_type => XSD::QName.new(NsV1, "FindInventoryResponseType"),
    :schema_element => [
      ["promiseLinesOutput", ["MySoap::Interface989386629::PromiseLinesOutputType[]", XSD::QName.new(nil, "PromiseLinesOutput")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface989386629::PromiseLinesOutputType,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface989386629::FindGlobalInventoryRequestType,
  ...
  LiteralRegistry.register(
    :class => MySoap::Interface989386629::FindInventoryRequest,
    :schema_name => XSD::QName.new(NsV1, "FindInventoryRequest"),
    :schema_element => [
      ["promiseLinesInput", ["MySoap::Interface989386629::PromiseLinesInputType[]", XSD::QName.new(nil, "PromiseLinesInput")]]
    ]
  )
  ...
  LiteralRegistry.register(
    :class => MySoap::Interface989386629::FindInventoryByDCRequest,
