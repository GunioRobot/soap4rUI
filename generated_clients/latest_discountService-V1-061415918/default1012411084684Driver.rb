...
module MySoap::Interface1242618608_1016410255
...
class DiscountServicePortType < ::SOAP::RPC::Driver
  ...
  Methods = [
    ...
    [ "applyDiscount",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"MySoap::Interface1242618608_1016410255::DiscountServiceFault"=>{:namespace=>nil, :use=>"literal", :ns=>"http://services.gid.gap.com/discountService/v1", :encodingstyle=>"document", :name=>"DiscountServiceFault"}} }
    ]
  ]
