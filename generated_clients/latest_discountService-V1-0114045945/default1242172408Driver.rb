...
require 'default1242172408MappingRegistry.rb'
require 'soap/rpc/driver'

module MySoap::Interface190823110
...
class DiscountServicePortType < ::SOAP::RPC::Driver
  ...
  Methods = [
    ...
    [ "applyDiscount",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"MySoap::Interface190823110::DiscountServiceFault"=>{:ns=>"http://services.gid.gap.com/discountService/v1", :name=>"DiscountServiceFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ]
  ]
