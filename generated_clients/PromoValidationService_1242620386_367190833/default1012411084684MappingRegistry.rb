...
module MySoap; module Interface1129456511
...
module DefaultMappingRegistry
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1129456511::CreditCardValidationRequest,
  ...
  EncodedRegistry.set(
    MySoap::Interface1129456511::ArrayOf_xsd_string,
    ::SOAP::SOAPArray,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1129456511::PromotionUsage,
  ...
  EncodedRegistry.set(
    MySoap::Interface1129456511::ArrayOf_PromotionUsage,
    ::SOAP::SOAPArray,
    ::SOAP::Mapping::EncodedRegistry::TypedArrayFactory,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1129456511::CreditCardValidationInfo,
    ...
    :schema_element => [
      ...
      ["promotionUsageHistory", ["MySoap::Interface1129456511::ArrayOf_PromotionUsage", XSD::QName.new(nil, "promotionUsageHistory")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1129456511::CreditCardValidationResponse,
    :schema_type => XSD::QName.new(NsProviderV1PromotionServicesGidGapCom, "CreditCardValidationResponse"),
    :schema_element => [
      ["creditCardValidationInfo", ["MySoap::Interface1129456511::CreditCardValidationInfo", XSD::QName.new(nil, "creditCardValidationInfo")]]
    ]
  )

  EncodedRegistry.register(
    :class => MySoap::Interface1129456511::PromotionServiceException,
  ...
  EncodedRegistry.register(
    :class => MySoap::Interface1129456511::PromoValidationException,
